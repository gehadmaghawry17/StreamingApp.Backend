        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrailerUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromotedContents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchCount = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SearchTrends", x => new { x.Term, x.Date });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favorites", x => new { x.UserId, x.ContentType, x.ContentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ratings", x => new { x.UserId, x.ContentType, x.ContentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViewingProgress", x => new { x.UserId, x.ContentType, x.ContentId });
                    table.ForeignKey(
                        name: "FK_ViewingProgress_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Downloads_ContentTarget", "([MovieId] IS NOT NULL AND [EpisodeId] IS NULL) OR ([MovieId] IS NULL AND [EpisodeId] IS NOT NULL)");
                    table.ForeignKey(
                        name: "FK_Downloads_Episodes_EpisodeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_WatchHistory_ContentTarget", "([MovieId] IS NOT NULL AND [EpisodeId] IS NULL) OR ([MovieId] IS NULL AND [EpisodeId] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UX_DeviceSessions_UserId",
                table: "DeviceSessions",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Downloads_EpisodeId",
                table: "Downloads",
                column: "EpisodeId");
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Episodes_SeasonId_EpisodeNumber",
                table: "Episodes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movies_IsPublished_CreatedAt",
                table: "Movies",
                columns: new[] { "IsPublished", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "UX_Movies_PublicId",
                table: "Movies",
                column: "PublicId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotedContent_IsActive_DisplayOrder",
                table: "PromotedContents",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Seasons_SeriesId_SeasonNumber",
                table: "Seasons",
                columns: new[] { "SeriesId", "SeasonNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Series_IsPublished_CreatedAt",
                table: "Series",
                columns: new[] { "IsPublished", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "UX_Series_PublicId",
                table: "Series",
                column: "PublicId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeriesGenre_GenreId_SeriesId",
                table: "SeriesGenre",
                columns: new[] { "GenreId", "SeriesId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ViewingProgress_UserId_LastWatchedAt",
                table: "ViewingProgress",
